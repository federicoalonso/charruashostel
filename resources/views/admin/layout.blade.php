...
<head>
    <!-- Estilos Generales -->
    @include('admin.partials.estilosGen')
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                <img src="/img/logoArmada2.jpg" alt="PLA Logo" class="brand-image img-circle elevation-3 " style="opacity: .8">
                <span class="brand-text font-weight-light">Programa Logístico</span>
            </a>
